...
#: `redact_tree` and sweeping every surface: only `someone@example.com` leaks, because it
...
STAR_QUERY = "select * from wide_events where actor_email = 'someone@example.com'"
